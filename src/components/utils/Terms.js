...
function Terms() {
  return (
    <div style={{ overflowY: "scroll", padding: "5rem 2rem" }}>
      <h1>Terms and Conditions</h1>
      <p style={{ color: "#777474" }}>Last updated: August 08, 2021</p>
      <p>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Crycto.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Crycto, accessible from&nbsp;
            <a
              href="https://crycto.io"
      ...
      <ul>
        <li>
          By email: <a href="mailto:support@crycto.io">admin@crycto.io</a>
        </li>
      </ul>
    </div>
  );
